...
En vuestro caso, la **pull request** va a ser el método de entrega para todos los labs.

## 🧠¿Pero cómo hacemos una *pull request*?🧠

Ya tenéis disponible el repositorio en la organización de GitHub de [python4menisco](https://github.com/juanmolera/python4menisco/tree/main) con los labs correspondiente al material dado durante las clases.

### Los pasos a seguir son los siguientes:

**1.** **Forkear**  :fork_and_knife: el repo del lab desde el GitHub de [python4menisco](https://github.com/juanmolera/python4menisco/tree/main) (aparecerá un repo con el mismo nombre en tu cuenta de GitHub)
...
Y ahora... ¡¡A trabajar!! :rocket: :rocket: :rocket: :rocket: